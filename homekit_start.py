...
from config.hjhome import HOMEKIT_NAME, SETUP_DIR, INSTANCE_DIR, \
    MAC_FILE, HOMEKIT_ACCESSORY_FILE
...
print("homekit2mqtt -m " + ACC_FILE + " -b " + HOMEKIT_NAME + " -a " + MAC_ADDR + " -c " + PIN_CODE)
os.system("homekit2mqtt -m " + ACC_FILE + " -b " + HOMEKIT_NAME + " -a " + MAC_ADDR + " -c " + PIN_CODE)
